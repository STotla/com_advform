...
<form action="<?php echo Route::_('index.php?option=com_advform&view=forms'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <?php else : ?>
                    <table class="table" id="formList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_ADVFORM_FORMS_TABLE_CAPTION'); ?>,
                                ...
                                <th scope="row" class="has-context">
                                    <div>
                                        ...
                                        <?php if ($canEdit || $canEditOwn) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_advform&task=form.edit&id=' . (int) $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
